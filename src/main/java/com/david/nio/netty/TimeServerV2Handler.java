...
public class TimeServerV2Handler extends ChannelInboundHandlerAdapter {

	@Override
	public void channelActive(ChannelHandlerContext ctx) throws Exception {
		final ByteBuf time = ctx.alloc().buffer(4);
		time.writeByte((int) (System.currentTimeMillis() / 1000L + Constants.TIME_ZONE)); // 默认格林尼治时间需要+2208988800L变成东八区
		/*
